...
rDownloadURL = {"main": "https://bitbucket.org/xtremaui8080/main/downloads/main_xtreamcodes_reborn.tar.gz", "sub": "https://bitbucket.org/xtremaui8080/main/downloads/sub_xtreamcodes_reborn.tar.gz"}
...
def installadminpanel():
    rURL = "https://bitbucket.org/xtremaui8080/main/downloads/release_22f.zip"
    ...
    rURL2 = "https://bitbucket.org/xtremaui8080/main/downloads/newstuff.zip"
...
def configure():
    ...
    if not "/home/xtreamcodes/iptv_xtream_codes/" in open("/etc/fstab").read():
        ...
        rFile.write("tmpfs /home/xtreamcodes/iptv_xtream_codes/streams tmpfs defaults,noatime,nosuid,nodev,noexec,mode=1777,size=90% 0 0\ntmpfs /home/xtreamcodes/iptv_xtream_codes/tmp tmpfs defaults,noatime,nosuid,nodev,noexec,mode=1777,size=1G 0 0")
        rFile.close()
    ...
    os.system("wget -q https://raw.githubusercontent.com/Kevin77807/preub/master/nginx -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx")
    os.system("wget -q https://raw.githubusercontent.com/Kevin77807/preub/master/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/sbin/nginx_rtmp")
    os.system("wget -q https://raw.githubusercontent.com/Kevin77807/preub/master/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
...
if __name__ == "__main__":
    ...
    print "%s │ Check out the mirror repo: https://xuiplay.x10.mx/install/install.py %s" % (col.OKGREEN, col.ENDC)
    print " "
